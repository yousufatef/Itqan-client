...
export default function FinancialTable() {
  ...
  const columns: ColumnDef<IFinancialInvoice>[] = [
    ...
    {
      header: 'الإجراءات',
      cell: ({ row }) => <FinancialActions student={row.original} />,
    },
  ];
    ...
    void exportArabicTableToPdf({
      ...
      columns: [
        { header: 'اسم الطالب', value: (invoice: IFinancialInvoice) => invoice.studentName },
        {
          ...
          value: (invoice: IFinancialInvoice) =>
        ...
        { header: 'الحالة', value: (invoice: IFinancialInvoice) => statusLabels[invoice.status] },
        { header: 'رقم الفاتورة', value: (invoice: IFinancialInvoice) => invoice.id },
      ],
      rows: items?.data ?? [],
    });
  };
    ...
    <div className='space-y-4'>
      <div className='flex flex-wrap items-center justify-between gap-3'>
        ...
        <Button
          ...
          className='border-primary-500 text-primary-500 hover:text-primary-500 flex items-center gap-1 border'
        >
